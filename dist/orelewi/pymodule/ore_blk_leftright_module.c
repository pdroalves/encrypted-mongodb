...
py_ore_blk_setup(PyObject *self, PyObject *args){
  ...
  if (!PyArg_ParseTuple(args, "II",&params->nbits,&params->block_len))
    return NULL;
...
PyMODINIT_FUNC
initLewiWuOREBlkLF(void)
{ 
  (void) Py_InitModule("LewiWuOREBlkLF", OREBLKMethods);
}
